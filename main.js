(function(){
  ...
  var HOUSE_ICON = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><path d="M3 11 12 4l9 7"/><path d="M5 10v9h14v-9"/><path d="M10 19v-6h4v6"/></svg>';
  for (var i = 0; i < 8; i++){
    var a = document.createElement('a');
    a.className = 'ig-tile';
    a.href = 'https://instagram.com/volumensur';
